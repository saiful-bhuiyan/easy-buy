                ...
                <div class="form-tab">
                    ...
                    <div class="tab-content">
                        <div class="" style="display: block;">
                            <form action="{{ route('update.password') }}" method="post" style="margin-top: 40px;">
                                @csrf
                                <div class="form-group" hidden>
                                    <label for="singin-email-2">token *</label>
                                    <input type="text" class="form-control" id="singin-email-2" name="token" value="{{ $token }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="singin-email-2">Password *</label>
                                    <input type="text" class="form-control" id="singin-email-2" name="password" autocomplete="off" required>
                                </div>
                                <div class="form-group">
                                    <label for="singin-email-2">Confirm Password *</label>
                                    <input type="text" class="form-control" id="singin-email-2" name="password_confirmation" autocomplete="off" required>
                                </div>

...
<main class="main">
    <div class="page-header text-center" style="background-image: url('{{ asset('frontend') }}/assets/images/page-header-bg.jpg')">
        <div class="container">
            ...
            <h1 class="page-title">{{ $getSubCategory->title }}<span>Shop</span></h1>
            @else
            <h1 class="page-title">{{ $getCategory->title }}<span>Shop</span></h1>
            @endif
        </div><!-- End .container -->
    </div><!-- End .page-header -->
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
        <div class="container">
            <ol class="breadcrumb">
                ...
                @if(!empty($getSubCategory))
                <li class="breadcrumb-item"><a href="{{ url($getCategory->slug) }}">{{ $getCategory->title }}</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ $getSubCategory->title }}</li>
                @else
            ...
            <div class="row">
                ...
                <aside class="col-lg-3 order-lg-first">
                    <form id="filter_form" method="POST" hidden>
                        <input type="text" name="sub_category_list" id="sub_category_list" value="@if(isset($getSubCategory)) {{ $getSubCategory->id }} @endif">
                            ...
                            <div class="collapse show" id="widget-1">
                                <div class="widget-body">
                                    <div class="filter-items filter-items-count">
                                        ...
                                        @foreach($getCategory->SubCategory as $f_category)
                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input ChangeCategory" id="subcat-{{ $f_category->id }}" value="{{ $f_category->id }}" @if(isset($getSubCategory) && $f_category->id == $getSubCategory->id) checked @endif>
                                                <label class="custom-control-label" for="subcat-{{ $f_category->id }}">{{ $f_category->title }}</label>
                                            </div><!-- End .custom-checkbox -->
                                            <span class="item-count">{{ $f_category->Product->count() }}</span>
                                        </div><!-- End .filter-item -->
                                        @endforeach
